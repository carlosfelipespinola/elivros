...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post livros_url, params: { livro: { capa_img_url: @livro.capa_img_url, string: @livro.string, titulo: @livro.titulo } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { capa_img_url: @livro.capa_img_url, string: @livro.string, titulo: @livro.titulo } }
